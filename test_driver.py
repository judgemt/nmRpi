...
driver.move(driver_number=1, direction='Counterclockwise', n_steps=150, steps_per_second=50)
driver.move(driver_number=0, direction='Clockwise', n_steps=150, steps_per_second=50)
driver.move(driver_number=1, direction='Clockwise', n_steps=150, steps_per_second=50)
